...
> = {
	...
	InterfaceMismatch: Exclude<ExtractMethodNames<TypedInterface>, ExtractMethodNames<BaseInterface, ExcludeFromBase>> | 
					   Exclude<ExtractMethodNames<BaseInterface, ExcludeFromBase>, ExtractMethodNames<TypedInterface>>;
};
...
> = {
	...
	ParameterCountMismatches: {
		[K in ExtractMethodNames<BaseInterface, ExcludeFromBase> & ExtractMethodNames<TypedInterface>]: 
			GetParameterCount<BaseInterface[K]> extends GetParameterCount<TypedInterface[K]>
				? GetParameterCount<TypedInterface[K]> extends GetParameterCount<BaseInterface[K]>
					? never
					: K
				: K;
...
> = {
	...
	Result: CheckMethodNames<BaseInterface, TypedInterface, ExcludeFromBase>['InterfaceMismatch'] extends never
		? CheckParameterCounts<BaseInterface, TypedInterface, ExcludeFromBase>['ParameterCountMismatches'] extends never
			? true
			: {
...
export type AssertInterfacesMatch<
	...
	TypedInterface,
	ExcludeFromBase extends keyof BaseInterface = never
> = VerifyInterfaceSync<BaseInterface, TypedInterface, ExcludeFromBase>['Result'];
