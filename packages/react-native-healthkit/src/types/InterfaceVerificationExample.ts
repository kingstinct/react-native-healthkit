...
const _exampleVerification: InterfaceAssertion<ExampleModule, ExampleModuleTyped, keyof HybridObject> = true;
...
const _configVerification: InterfaceAssertion<ConfigModule, ConfigModuleTyped, keyof HybridObject> = true;
