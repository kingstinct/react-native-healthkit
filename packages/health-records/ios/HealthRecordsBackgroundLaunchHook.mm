...
@interface HealthRecordsBackgroundLaunchHook : NSObject
@end

@implementation HealthRecordsBackgroundLaunchHook
  ...
  [[NSNotificationCenter defaultCenter]
      addObserverForName:UIApplicationDidFinishLaunchingNotification
              ...
              usingBlock:^(NSNotification *_Nonnull note) {
                Class managerClass = NSClassFromString(@"HealthRecordsBackgroundDeliveryManager");
