...
type ReactNativeHealthkitTypeNative = {
    ...
    * @see {@link https://developer.apple.com/documentation/healthkit/hkhealthstore/1614152-requestauthorization Apple Docs }
    ...
    readonly queryStatisticsCollectionForQuantity: <TIdentifier extends HKQuantityTypeIdentifier, TUnit extends UnitForIdentifier<TIdentifier>>(identifier: HKQuantityTypeIdentifier, unit: TUnit, from: string, to: string, options: readonly HKStatisticsOptions[]) => Promise<readonly HKStatistics<TIdentifier, TUnit>[]>;
    readonly queryActivitySummaryForQuantity: <TEnergyUnit extends EnergyUnit, TTimeUnit extends TimeUnit>(energyUnit: TEnergyUnit, timeUnit: TTimeUnit, from: string, to: string) => Promise<readonly HKActivitySummary<TEnergyUnit, TTimeUnit>[]>;
